 ...
 *
 * @author  Ivan Z. Ganza
 * @version $Id: SpaceInvaders.java,v 1.1 2005/02/18 03:05:00 ivan_ganza Exp $
 */
public class SpaceInvaders {
	...
	for (int i = 0; i < 15; i++) {
	    AlienShip ship = new AlienShip(gl, "testdata" + File.separator + "space_invaders" + File.separator + "small_alien.bmp");
	...
	for (int i = 0; i < 15; i++) {
	    AlienShip ship = new AlienShip(gl, "testdata" + File.separator + "space_invaders" + File.separator + "medium_alien.bmp");
	...
	for (int i = 0; i < 15; i++) {
	    AlienShip ship = new AlienShip(gl, "testdata" + File.separator + "space_invaders" + File.separator + "large_alien.bmp");
