...
int main(int argc, char *argv[]) {
    ...
    //I still hate grey
    if ((col1.red > col1.green) && (col1.red > col1.blue)){
      col2.red = col2.red + half;
    }
    else if ((col1.green > col1.red) && (col1.green > col1.blue)){
      col2.green = col2.green + half;
    }
    else if ((col1.blue > col1.green) && (col1.blue > col1.red)){
      col2.blue = col2.blue + half;
    }
    else if (approximately(col1.red, col1.green, dist) == 0){
      col2.red = col2.red + half;
      col2.green = col2.green + half;
    }
    else if (approximately(col1.blue, col1.green, dist) == 0){
      col2.green = col2.green + half;
      col2.blue = col2.blue + half;
    }
    else if (approximately(col1.blue, col1.red, dist) == 0){
      col2.red = col2.red + half;
      col2.blue = col2.blue + half;
    }
    else{
