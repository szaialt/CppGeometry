...
//       else {  
       ...
       for (int i = 0; i < symmetry; i++){
         ...
         ((polygon.rotate(width/2, height/2, delta*i)).mirror(width)).draw(screen, d);
         (((polygon.rotate(width/2, height/2, delta*i)).mirror(width)).rotate(width/2, height/2, delta*i)).draw(screen, d);
       }
